 ...
 */
@Service
public class OrgPermissionFunRelationServiceImpl extends BaseServiceImpl<OrgPermissionFunRelationMapper, OrgPermissionFunRelation> implements IOrgPermissionFunRelationService {
	/**
	 * 角色绑定功能权限
	 *
	 * @param RoleId
